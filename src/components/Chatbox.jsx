...
const Chatbox = ({selectedUser}) => {
  ...
  return (<>
  {selectedUser?    <section className="flex flex-col items-start justify-start h-screen w-[100%] background-image">
      <header className="border-b border-gray-400 w-[100%] h-[82px] m:h-fit p-4 bg-white">
        <main className="flex items-center gap-3">
          ...
          <span>
            ...
            <p className="font-light text-[#2A3D39] text-sm">@ {selectedUser?.username || "Unknown User"}</p>
          </span>
        </main>
      </header>
